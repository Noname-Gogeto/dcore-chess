...
import 'package:chess/views/components/chess_view/game_info_and_controls/moves_undo_redo_row/undo_redo_buttons.dart';
      ...
      children: [
        Row(
          children: [
            ...
            appModel.showMoveHistory && appModel.allowUndoRedo ? const SizedBox(width: 10) : Container(),
            appModel.allowUndoRedo ? Expanded(child: UndoRedoButtons(appModel)) : Container(),
          ],
        ),
        appModel.showMoveHistory || appModel.allowUndoRedo ? const SizedBox(height: 10) : Container(),
      ],
    );
  }
}
